...
import com.billing.billingsoftware.io.*;
import com.billing.billingsoftware.repository.OrderEntityRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public List<OrderResponse> findRecentOrders() {
        return orderEntityRepository.findRecentOrders(PageRequest.of(0, 20))
                .stream()
