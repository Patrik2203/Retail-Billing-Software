...
const Login = () => {
    ...
    const navigate = useNavigate();
     ...
     // Handler for auto-filling credentials when demo credentials are clicked
     const handleCredentialClick = (email, password) => {
        setData({
            email: email,
            password: password
        });
        toast.success(`${email === 'admin@demo.com' ? 'Admin' : 'User'} credentials loaded!`);
     }
        ...
        <div className="bg-light d-flex align-items-center justify-content-center vh-100 login-background">
            <div className="card shadow-lg w-100" style={{ maxWidth: '480px' }}>
                <div className='card-body'>
                    ...
                    {/* Add the LoginCredentials component here */}
                    <LoginCredentials onCredentialClick={handleCredentialClick} />
